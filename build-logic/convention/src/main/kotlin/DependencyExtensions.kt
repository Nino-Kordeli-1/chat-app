...
internal fun DependencyHandler.implementation(libs: VersionCatalog, name: String)
: Dependency? = add(
        Configurations.IMPLEMENTATION,
        libs.findLibrary(name).get()
    )

internal fun DependencyHandler.testImplementation(libs: VersionCatalog, name: String)
: Dependency? = add(
...
internal fun DependencyHandler.ksp(libs: VersionCatalog, name: String)
: Dependency? = add(
        Configurations.KSP,
        libs.findLibrary(name).get()
    )
